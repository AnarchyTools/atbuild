...
`atbuild` is a cross-platform build system, primarily for Swift-language projects, following the [Anarchy Tools philosophy](http://http://anarchytools.org/) of simple, unopinionated, hackable tools.
